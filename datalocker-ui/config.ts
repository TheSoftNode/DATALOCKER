...
export const DATALOCKER_ADDRESSES = {
  // ✅ DEPLOYED: DataLocker contract address on Calibration testnet (Updated with 5 USDFC minimum)
  DATALOCKER_CONTRACT: "0x5b4495F43501842C513afef03e581f0791fDe406", // NEW DEPLOYMENT WITH 5 USDFC MIN ✅
...
export const DATALOCKER_CONFIG = {
  ...
  MIN_DEPOSIT_USDFC: 5, // USDFC - Reduced for testing
