...
A Next.js frontend for the DataLocker perpetual storage solution on Filecoin.

## Overview

DataLocker provides:

- Perpetual file storage on Filecoin with auto-renewal
- FIL and USDFC payment options for storage deposits
- Real-time monitoring of storage expiration and renewals
- Integration with SynapseSDK for production-ready Filecoin storage
