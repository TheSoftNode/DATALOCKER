...
import { DataLockerUploader } from "../components/DataLockerUploader";
import { motion, AnimatePresence } from "framer-motion";
import Confetti from "@/components/ui/Confetti";
import { useConfetti } from "@/hooks/useConfetti";
import { MyStorageRecords } from "@/components/MyStorageRecords";
  ...
  return (
    <div className="w-full flex flex-col justify-center min-h-fit">
      ...
      >
        ...
        >
          perpetual storage on filecoin with{" "}
          <motion.a
          ...
          {!isConnected ? (
            ...
            >
              ...
              <motion.p variants={itemVariants} className="mt-3 text-secondary">
                Please connect your wallet to use DataLocker
              </motion.p>
            </motion.div>
          ) : (
            <motion.div
            ...
            >
              <motion.div variants={itemVariants} className="flex mb-6">
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={() => setActiveTab("my-storage")}
                  className={`flex-1 py-2 px-4 text-center border-b-2 transition-colors ${
